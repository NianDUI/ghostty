...
extension TerminalWindow {
    ...
    func configureTabContextMenuIfNeeded(_ menu: NSMenu) {
        ...
        let item = NSMenuItem(title: LocalizedString.text("Close Tabs to the Right"), action: #selector(TerminalController.closeTabsOnTheRight(_:)), keyEquivalent: "")
    ...
    private func appendTabModifierSection(to menu: NSMenu, target: TerminalController?) {
        ...
        // Rename Tab...
        let changeTitleItem = NSMenuItem(title: LocalizedString.text("Rename Tab..."), action: #selector(TerminalWindow.renameTabFromContextMenu(_:)), keyEquivalent: "")
